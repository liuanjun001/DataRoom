...
showPopUpWindow: function(url,title,param,callback) {
	...
	win_height=(param.height+120)+"px";
        ...
        var content = '<div  id="PopUpWindow'+winid+'"  class="modal fade in" style="display: none;background: rgba(102,102,102,0.5);"  data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" role="dialog"      aria-hidden="true">' +
	...
	//	parent.$("#PopUpWindow"+winid).css("overflow", "hidden");//禁止模态对话框的半透明背景滚动
		...
		$("#iframe_PopUpWindow"+winid).load(function() {
		try
		{
