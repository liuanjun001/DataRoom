...
"		<div class='col-xs-4 col-md-4 span4' style='padding-right:5px;padding-left:5px;padding-top:5px;padding-bottom:5px'>"+
"		<div class='panel panel-primary' style='width:100%;height:100%;margin-bottom:0px'>"+
"				<div id='robotmyhomepanelhead7' class='panel-heading' style='cursor:pointer'>"+
"					<h3 id='robotmyhomepaneltitle7' class='panel-title'>"+
item.module7title+
"					</h3>"+
"				</div>"+
"				<div id='robotmyhomepanel7' class='panel-body' style='height:"+panelheight+"px;padding:5px'>"+
"<p>开发中...</p>"+
"				</div>"+
"			</div>"+
"		</div>"+
...
"		<div class='col-xs-4 col-md-4 span4' style='padding-right:5px;padding-left:5px;padding-top:5px;padding-bottom:5px'>"+
"		<div class='panel panel-primary' style='width:100%;height:100%;margin-bottom:0px'>"+
"				<div id='robotmyhomepanelhead8' class='panel-heading' style='cursor:pointer'>"+
"					<h3 id='robotmyhomepaneltitle8' class='panel-title'>"+
item.module8title+
"					</h3>"+
"				</div>"+
"				<div id='robotmyhomepanel8' class='panel-body' style='height:"+panelheight+"px;padding:5px'>"+
"<p>开发中...</p>"+
"				</div>"+
"			</div>"+
"		</div>"+
...
"		<div class='col-xs-4 col-md-4 span4' style='padding-right:5px;padding-left:5px;padding-top:5px;padding-bottom:5px'>"+
"		<div class='panel panel-primary' style='width:100%;height:100%;margin-bottom:0px'>"+
"				<div id='robotmyhomepanelhead9' class='panel-heading' style='cursor:pointer'>"+
"					<h3 id='robotmyhomepaneltitle9' class='panel-title'>"+
item.module9title+
"					</h3>"+
"				</div>"+
"				<div id='robotmyhomepanel9' class='panel-body' style='height:"+panelheight+"px;padding:5px'  >"+
"<p>开发中...</p>"+
"				</div>"+
"			</div>"+
"		</div>"+
