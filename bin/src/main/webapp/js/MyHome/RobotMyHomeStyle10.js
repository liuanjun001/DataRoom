...
"					</h3>"+
"				</div>"+
"				<div id='robotmyhomepanel2' class='panel-body' style='height:170px;padding:5px'>"+
"<p>开发中...</p>"+
"				</div>"+
"			</div>"+
...
"					</h3>"+
"				</div>"+
"				<div id='robotmyhomepanel3' class='panel-body' style='height:"+(panelheight*2/3-218)+"px;padding:5px'>"+
"<p>开发中...</p>"+
"				</div>"+
"			</div>"+
"		</div>"+
"	</div>"+
"	<div class='row' style='width:100%;height:100%;margin-right:5px;margin-left:5px;margin-top:5px;margin-bottom:5px'>"+
"		<div class='col-xs-12 col-md-12 span12' style='padding-right:5px;padding-left:5px;padding-top:5px;padding-bottom:5px'>"+
"		<div class='panel panel-primary' style='width:100%;height:100%;margin-bottom:0px'>"+
...
"					</h3>"+
"				</div>"+
"				<div id='robotmyhomepanel4' class='panel-body' style='height:"+(panelheight/3)+"px;padding:5px'>"+
"<p>开发中...</p>"+
"				</div>"+
"			</div>"+
"		</div>"+
