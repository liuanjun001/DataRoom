var RobotMonthYjUtilizationGrid={
		id:1,
	viewObject:null,
	container:null,
	myChart:null,
...
"columnDefs":[{targets:[0],data:"stationname"},{targets:[1],data:"devicename"},{targets:[2],data:"ratio"},{targets:[3],data:"uptime"}]
	...
	refresh:function(event){
		...
		robotservice.callrobotservice("ResourcesService","QueryMonthTop10YJList",{},obj==null?this.showdata:obj.showdata,obj==null?this:obj);
