...
RobotAreaWarnMapCompent.areamap[areadata[i].mapcode!=null?areadata[i].mapcode:areadata[i].areacode]=areadata[i].areaname;
			}
			 robotservice.areacode=areadata[0].mapcode!=null?areadata[0].mapcode:areadata[0].areacode;
...
callobj.refresh({data:{targetobj:callobj}});
	...
	refresh:function(event){
		...
		robotservice.callrobotservice("Smartlightservice","MonitorMyMapWarn",{lenareacode:obj==null?this.showareacode.length+2:obj.showareacode.length+2,areacode:obj==null?this.showareacode:obj.showareacode},obj==null?this.showdata:obj.showdata,obj==null?this:obj);
	},
	showdata:function(data,callobj){
		...
		for(var i=0;i<data.length;i++){
			timedata[i]=data[i].areacode;
			 data1[i]={name:RobotAreaWarnMapCompent.areamap[data[i].areacode],value:data[i].cn,areacode:data[i].areacode};
