var RobotAreaPueMonthLineCompent={
	id:1,
	viewObject:null,
	container:null,
	myChart:null,
	...
	initWiget:function(){
		   this.myChart = echarts.init(document.getElementById('RobotAreaPueMonthchart'+this.id),echarttheme);
		 this.option = {
color:['#ff0000','#ffae00','#f6ff00','#26c0fe'],
 ...
 this.refresh();
	...
	refresh:function(event){
		...
		robotservice.callrobotservice("Pueservice","GetAreaMonthPueInfo",{areacode:null},obj==null?this.showdata:obj.showdata,obj==null?this:obj);
	},
