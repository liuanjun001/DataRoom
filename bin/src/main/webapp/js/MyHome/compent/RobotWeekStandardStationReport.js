var RobotWeekStandardStationReport={
	id:1,
	viewObject:null,
	container:null,
	myChart:null,
	...
	getHtml:function(item,nwidth,nheight){
		return "<div class='col-md-12 col-xs-12 span12'  id='RobotWeekStandardStationReportchart"+this.id+"' style='height:"+(nheight!=null?nheight+"px":"100%")+";width:"+(nwidth!=null?nwidth+"px":"100%")+";margin:0px;padding:0px'></div>";
	},
	initWiget:function(){
		   this.myChart = echarts.init(document.getElementById('RobotWeekStandardStationReportchart'+this.id),echarttheme);
		 this.option = {
color:['#ff0000','#ffae00','#f6ff00','#26c0fe'],
 ...
 this.refresh();
	...
	refresh:function(event){
		...
		robotservice.callrobotservice("RTWarnService","QueryWeekStandardStationCount",{},obj==null?this.showdata:obj.showdata,obj==null?this:obj);
	},
