var RobotMonthByqUtilizationGrid={
		id:1,
	viewObject:null,
	container:null,
	myChart:null,
	...
	getHtml:function(item,nwidth,nheight){
		...
		"<th>局站</th><th>变压器品牌</th><th>利用率</th><th>时间</th>"+
...
"columnDefs":[{targets:[0],data:"stationname"},{targets:[1],data:"devicename"},{targets:[2],data:"ratio"},{targets:[3],data:"uptime"}]
	...
	refresh:function(event){
		...
		robotservice.callrobotservice("ResourcesService","QueryMonthTop10BYQList",{},obj==null?this.showdata:obj.showdata,obj==null?this:obj);
